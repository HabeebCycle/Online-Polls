package com.habeebcycle.onlinepoll.service;

import com.habeebcycle.onlinepoll.exception.BadRequestException;
import com.habeebcycle.onlinepoll.exception.ResourceNotFoundException;
import com.habeebcycle.onlinepoll.model.*;
import com.habeebcycle.onlinepoll.payload.PagedResponse;
import com.habeebcycle.onlinepoll.payload.PollRequest;
import com.habeebcycle.onlinepoll.payload.PollResponse;
import com.habeebcycle.onlinepoll.payload.VoteRequest;
...
import com.habeebcycle.onlinepoll.util.ModelMapper;
...
public class PollService {
    ...
    public PagedResponse<PollResponse> getAllPolls(UserPrincipal currentUser, int page, int size){
        ...
        Page<Poll> polls = pollRepository.findAll(pageable); //Pagination enabled using 'pageable' variable
        //List<Poll> pL = pollRepository.findAll();
